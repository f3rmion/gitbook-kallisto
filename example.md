...
{% hint style="success" %}
`xmol` files can be nicely visualized by the [atomic simulation environment](https://wiki.fysik.dtu.dk/ase/install.html). Once you have installed ASE, you can use their GUI to visualize `xmol` structures
{% endhint %}
