...
We apply static atomic polarizabilities for the calculation of vdW radii. The graphic below depicts calculated vdW radii \(`vdwtype=rahm`\) or all atoms up to Radon \(CN = 0, q = 0\).
