...
This atomic feature is useful to determine the steric hindrance from neighboring groups. The depiction below exemplifies this for the toluene molecule \(see Applications part\), where higher CNSP-values show a higher steric hindrance.
