...
| Timings\* in seconds | [_dftd4_](https://github.com/dftd4/dftd4/tree/main/python)__ | __[_kallisto_](https://github.com/AstraZeneca/kallisto)__ | __[_AlphaML_](https://tools.materialscloud.org/alphaml/input_structure/)__ |
| -------------------- | ------------------------------------------------------------ | --------------------------------------------------------- | -------------------------------------------------------------------------- |
